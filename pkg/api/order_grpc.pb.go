...
const (
	...
	OrderService_GetStatusOrder_FullMethodName = "/order.OrderService/GetStatusOrder"
...
type OrderServiceClient interface {
	...
	GetStatusOrder(ctx context.Context, in *GetStatusOrderRequest, opts ...grpc.CallOption) (*GetStatusOrderResponse, error)
...
func (c *orderServiceClient) GetStatusOrder(ctx context.Context, in *GetStatusOrderRequest, opts ...grpc.CallOption) (*GetStatusOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetStatusOrderResponse)
	err := c.cc.Invoke(ctx, OrderService_GetStatusOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	GetStatusOrder(context.Context, *GetStatusOrderRequest) (*GetStatusOrderResponse, error)
...
func (UnimplementedOrderServiceServer) GetStatusOrder(context.Context, *GetStatusOrderRequest) (*GetStatusOrderResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStatusOrder not implemented")
}
...
func _OrderService_GetStatusOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStatusOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).GetStatusOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_GetStatusOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetStatusOrder(ctx, req.(*GetStatusOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStatusOrder",
			Handler:    _OrderService_GetStatusOrder_Handler,
		},
		{
